    ...
    try{
          await connectDb()
           ...
           Your task:
            ...
            If role is "delivery_boy" -> generate 3 short WhatsApp-style reply suggestion that delivery boy could  send to the user.

            Follow these rules:
            - Replies must match the context of the last messages.
            ...
            Return  only the three reply suggestios, comma-separated.
