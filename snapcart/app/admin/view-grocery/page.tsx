  ...
  return (
    <div className='pt-4 w-[95%] md:w-[85%] mx-auto pb-20'>
       ...
       <motion.form
        ...
        className='flex items-center bg-white border-gray-200 rounded-full px-5 py-3 shadow-sm mb-10 hover:shadow-lg transition-all max-w-lg mx-auto w-full'
        >
         ...
         {fillterd?.map((g,i)=>(
            <motion.div
             ...
             className='bg-white rounded-2xl shadow-md hover:shadow-xl border
              border-gray-100 flex flex-col sm:flex-row items-center sm:items-start gap-5 p-5 transition-all'
             >
             ...
             {editing && (
                ...
                >
                  ...
                  <div className='space-y-4'>
                    ...
                    className='w-full border border-gray-300 rounded-lg p-2.5 focus:ring:ring-2 focus:ring-green-500 outline-none'/>
                      
                      <select
                       className='w-full border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-green-500 outline-none bg-white'
