...
import { ChevronDown, ChevronUp, CreditCard, MapPin, Package, Phone, Truck, User, UserCheck, UserCheck2 } from 'lucide-react'
  ...
  return ( 
    ...
    key={order._id?.toString()}
     ...
     animate={{opacity:1, y:0}}
      ...
      <div className='flex flex-col md:flex-row md:flex-row md:item-start md:justify-between gap-4'>
        <div className='space-y-1'>
            ...
            <div className='mt-3 space-y-1 text-gray-700 text-sm'>
             ...
             {order.assignedDeliveryBoy && <div
             className='mt-4 bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-center justify-between'> 
                   ...
                   <button
                    onClick={()=>setExpanded(prev=>!prev)}
                     className='w-full flex justify-between items-center text-sm font-medium text-gray-700 hover:text-green-700 transition'  >
                      ...
                      {expanded? <ChevronUp size={16} className='text-green-600'/> : <ChevronDown 
