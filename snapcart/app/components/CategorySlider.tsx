  ...
  return (
    <motion.div
     ...
     >
       ...
       {showLeft &&  <button className='absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg hover:bg-green100 rounded-full w-10 h-10 flex items-center justify-center transitiona-all' onClick={()=>scroll("left")}><ChevronLeft className='w-6 h-6 text-green-700'/></button>  }
       ...
       {showRight &&   <button className='absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg hover:bg-green100 rounded-full w-10 h-10 flex items-center justify-center transitiona-all' onClick={()=>scroll("right")}><ChevronRight className='w-6 h-6 text-green-700'/></button>}
    </motion.div>
  ) 
}
